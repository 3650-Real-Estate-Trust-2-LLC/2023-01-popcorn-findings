...
|---|---|---|---|
|  [G-01]  | Using fixed bytes is cheaper than strings  | 2 | - |
|  [G-02]  | Usage of uint/int smaller than 32 bytes (256 bits) incurs overhead  | 4 | - |
|  [G-03]  | `<x> += <y>` Costs More Gas Than `<x> = <x> + <y>` For State Variables  | 11 | - |
|  [G-04]  | Using `unchecked` blocks to save gas  | 2 | 272 |
|  [G-05]  | Internal functions only called once can be inlined to save gas  | 9 | 180 |
|  [G-06]  | `abi.encode()` is less efficient than `abi.encodePacked()`  | 3 | - |
|  [G-07]  | Setting the `constructor` to `payable`  | 9 | 117 |
|  [G-08]  | Empty blocks should be removed or emit something  | 7 | - |
|  [G-09]  | Not using the named return variables when a function returns, wastes deployment gas  | 1 | - |
|  [G-10]  | Superfluous event fields  | 1 | - |

## [G-01] Using fixed bytes is cheaper than strings

As a rule of thumb, use `bytes` for arbitrary-length raw byte data and string for arbitrary-length `string `(UTF-8) data. If you can limit the length to a certain number of bytes, always use one of `bytes1` to `bytes32` because they are much cheaper.

https://github.com/code-423n4/2023-01-popcorn/blob/d95fc31449c260901811196d617366d6352258cd/src/utils/MultiRewardStaking.sol#L31-L32
https://github.com/code-423n4/2023-01-popcorn/blob/d95fc31449c260901811196d617366d6352258cd/src/vault/adapter/beefy/BeefyAdapter.sol#L24-L25
...
https://github.com/code-423n4/2023-01-popcorn/blob/d95fc31449c260901811196d617366d6352258cd/src/utils/MultiRewardStaking.sol#L33
https://github.com/code-423n4/2023-01-popcorn/blob/d95fc31449c260901811196d617366d6352258cd/src/utils/MultiRewardStaking.sol#L307-L308
https://github.com/code-423n4/2023-01-popcorn/blob/d95fc31449c260901811196d617366d6352258cd/src/vault/Vault.sol#L38
...
https://github.com/code-423n4/2023-01-popcorn/blob/d95fc31449c260901811196d617366d6352258cd/src/vault/VaultController.sol#L141-L145
https://github.com/code-423n4/2023-01-popcorn/blob/d95fc31449c260901811196d617366d6352258cd/src/vault/VaultController.sol#L154
https://github.com/code-423n4/2023-01-popcorn/blob/d95fc31449c260901811196d617366d6352258cd/src/vault/VaultController.sol#L242-L243
https://github.com/code-423n4/2023-01-popcorn/blob/d95fc31449c260901811196d617366d6352258cd/src/vault/VaultController.sol#L256-L257
...
https://github.com/code-423n4/2023-01-popcorn/blob/d95fc31449c260901811196d617366d6352258cd/src/vault/VaultController.sol#L692
https://github.com/code-423n4/2023-01-popcorn/blob/d95fc31449c260901811196d617366d6352258cd/src/vault/adapter/abstracts/AdapterBase.sol#L479
...
https://github.com/code-423n4/2023-01-popcorn/blob/d95fc31449c260901811196d617366d6352258cd/src/vault/Vault.sol#L719-L727
...
https://github.com/code-423n4/2023-01-popcorn/blob/d95fc31449c260901811196d617366d6352258cd/src/vault/TemplateRegistry.sol#L24
https://github.com/code-423n4/2023-01-popcorn/blob/d95fc31449c260901811196d617366d6352258cd/src/vault/VaultRegistry.sol#L21
https://github.com/code-423n4/2023-01-popcorn/blob/d95fc31449c260901811196d617366d6352258cd/src/vault/Vault.sol#L473-L477
...
https://github.com/code-423n4/2023-01-popcorn/blob/d95fc31449c260901811196d617366d6352258cd/src/vault/AdminProxy.sol#L22

## [G-10] Superfluous event fields

`block.number` and `block.timestamp` are added to the event information by default, so adding them manually will waste additional gas.

https://github.com/code-423n4/2023-01-popcorn/blob/d95fc31449c260901811196d617366d6352258cd/src/vault/Vault.sol#L569
